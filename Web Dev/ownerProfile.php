...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $stmt2 = $conn->prepare("UPDATE owners SET ic_number = ?, phone_number = ?, gender = ? WHERE user_id = ?");
...
$sql = "SELECT u.name, u.email, o.ic_number, o.phone_number, o.gender 
        FROM user u 
...
<body class="bg-[#f4f4f7] font-['Inter'] p-4 sm:p-8">
    ...
    <div class="max-w-2xl mx-auto">
        <a href="proowner.php" class="text-blue-600 font-bold hover:underline mb-6 inline-block">← Back to Dashboard</a>
